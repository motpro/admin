...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1370685246, '18', './data/template/24_18_common_header_portal_lesson.tpl.php', './template/tpl', 'common/header_portal_lesson')
;?>
<!DOCTYPE html>
