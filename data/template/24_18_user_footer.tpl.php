...
0
|| checktplrefresh('./template/tpl/user/footer.htm', './template/tpl/common/footer.htm', 1371209425, '18', './data/template/24_18_user_footer.tpl.php', './template/tpl', 'user/footer')
;?>
		</div>
</div>
</div>
