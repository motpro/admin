...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1371016401, '18', './data/template/24_18_common_header_examination_admin.tpl.php', './template/tpl', 'common/header_examination_admin')
;?>
<!DOCTYPE html>
