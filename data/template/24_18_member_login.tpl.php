...
0
|| checktplrefresh('./template/tpl/member/login.htm', './template/default/common/seccheck.htm', 1371015747, '18', './data/template/24_18_member_login.tpl.php', './template/tpl', 'member/login')
;?><?php include template('common/header'); ?><?php $loginhash = 'L'.random(4);?><?php if(empty($_GET['infloat'])) { ?>
<div id="ct" class="container content" align="center">
<div class="" id="main_succeed" style="display: none">
<div class="f_c altw">
...
<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>">没有帐号？<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>"><?php echo $_G['setting']['reglinkname'];?></a></a>
</span>
<h3>登录</h3>
</div>
</div>
...
<select name="loginfield" style="float: left;" width="80" id="loginfield_<?php echo $loginhash;?>">
...
<td><input type="text" name="username" id="username_<?php echo $loginhash;?>" autocomplete="off" size="30" class="px p_fre" tabindex="1" value="<?php echo $username;?>" /> <a href="member.php?mod=<?php echo $_G['setting']['regname'];?>"><?php echo $_G['setting']['reglinkname'];?></a></td>
...
<td><input type="password" id="password3_<?php echo $loginhash;?>" name="password" onfocus="clearpwd()" size="30" class="px p_fre" tabindex="1" /> <a href="javascript:;" onclick="display('layer_login_<?php echo $loginhash;?>');display('layer_lostpw_<?php echo $loginhash;?>');" title="找回密码">找回密码</a></td>
...
<tr>
<th></th>
<td><label class="checkbox" for="cookietime_<?php echo $loginhash;?>">
<input type="checkbox" class="" name="cookietime" id="cookietime_<?php echo $loginhash;?>" tabindex="1" value="2592000" <?php echo $cookietimecheck;?> />自动登录</label></td>
</tr>
</table>
</div>
...
<th>&nbsp;</th>
<td>
<button class="btn btn-success btn-large" type="submit" name="loginsubmit" value="true" tabindex="1"><strong>登录</strong></button>
</td>
<td>
...
<form class="form-inline" method="post" autocomplete="off" id="lostpwform_<?php echo $loginhash;?>" class="cl" onsubmit="ajaxpost('lostpwform_<?php echo $loginhash;?>', 'returnmessage3_<?php echo $loginhash;?>', 'returnmessage3_<?php echo $loginhash;?>', 'onerror');return false;" action="member.php?mod=lostpasswd&amp;lostpwsubmit=yes&amp;infloat=yes">
<div class="c cl">
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
