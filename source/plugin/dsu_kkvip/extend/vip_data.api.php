...
if(defined('IN_ADMINCP') && $_GET['api']){
	if(submitcheck('backup')){
		if(preg_match('/[^A-Za-z0-9_]/', $_GET['filename'])) cpmsg('&#25991;&#20214;&#21517;&#31216;&#21547;&#26377;&#38750;&#27861;&#23383;&#31526;&#65281;');
		$file = DISCUZ_ROOT."./data/vip_backup/{$_GET[filename]}.vbak";
		@touch($file);
		...
		cpmsg('&#22791;&#20221;&#25104;&#21151;&#65281;', "action=plugins&operation=config&identifier=dsu_kkvip&pmod=api&api={$_GET[api]}", 'succeed');
		dexit();
	}elseif(submitcheck('restore', 1)){
		$file = DISCUZ_ROOT."./data/vip_backup/{$_GET[filename]}";
		...
		cpmsg('&#36824;&#21407;&#25104;&#21151;&#65281;', "action=plugins&operation=config&identifier=dsu_kkvip&pmod=api&api={$_GET[api]}", 'succeed');
		dexit();
	}
	showtableheader('VIP&#25968;&#25454;&#22791;&#20221;');
	showformheader("plugins&operation=config&identifier=dsu_kkvip&pmod=api&api={$_GET[api]}");
	...
	while(false !== ($entry = $backup_dir->read())) {
		...
		if($file['extension'] == 'vbak' && $file['basename']) {
			showtablerow('', '', array(
				...
				'<a href="?action=plugins&operation=config&identifier=dsu_kkvip&pmod=api&api='.$_GET['api'].'&filename='.$file['basename'].'&restore=yes&formhash='.FORMHASH.'">&#24320;&#22987;&#36824;&#21407;</a>',
			));
			$flag = true;
		}
	}
